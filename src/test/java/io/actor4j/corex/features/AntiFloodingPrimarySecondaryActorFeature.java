...
import io.actor4j.core.features.PrimarySecondaryActorFeature;
import io.actor4j.corex.AntiFloodingActorSystemImpl;

public class AntiFloodingPrimarySecondaryActorFeature extends PrimarySecondaryActorFeature {
	@Before
	public void before() {
